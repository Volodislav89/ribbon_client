...
public class Example1Controller {
    ...
    public String showFirstService() {
        ...
        String serviceId = "spring-cloud-client".toLowerCase();
        ...
        html += "<br><h4>Call /dog/cloud of service: " + serviceId + "</h4>";
        ...
        try {
            ...
            String url = "http://" + serviceInstance.getHost() + ":" + serviceInstance.getPort() + "/dog/cloud";
